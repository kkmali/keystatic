...
const defaultLeftCta = {
  href: "/careers",
  text: "View open roles",
};

const defaultRightParagraphs = [
...
const defaultRightImages = [
  { src: "/about/3.webp", alt: "Modern workspace" },
  { src: "/about/4.webp", alt: "Team collaboration" },
];

export const AboutSection = ({
  leftImages = defaultLeftImages,
  leftTitle = "The team",
  leftParagraphs = defaultLeftParagraphs,
  leftCtaButton = defaultLeftCta,
  rightParagraphs = defaultRightParagraphs,
  rightImages = defaultRightImages,
}: {
  leftImages?: { src: string; alt: string }[];
  leftTitle?: string;
  leftParagraphs?: string[];
  leftCtaButton?: { href: string; text: string };
