...
sections:
  - discriminant: hero
    value:
      ...
      description: Mainline Astro template kghcf
      button_primary:
        label: Get template
      ...
      features:
        - title: Tailored workflows
          ...
          icon: lu:AlarmClockPlus
        - title: Cross-team projects
          description: Collaborate across teams and departments.
          icon: lu:ArrowBigUpDash
        - title: Milestones
  ...
  - discriminant: resource_allocation
    value:
      enable: true
        ...
        - title: Task discussions.
          ...
          images:
            - src: /resource-allocation/discussions.webp
              ...
              height: 103
          className: >-
            justify-normal [&>.title-container]:mb-5
            md:[&>.title-container]:mb-0 [&>.image-container]:flex-1
            md:[&>.image-container]:place-items-center
  ...
  - discriminant: pricing
    value:
      ...
      title: Pricing
      description: >-
        Use Mainline for free with your whole team. Upgrade to enable unlimited
  ...
  - discriminant: faq
    value:
      ...
      title: Got Questions?
      description: >-
        If you can't find what you're looking for, <a href="/contact"
